...
class CapabilityScout:
    ...
    async def research_once(self) -> dict:
        ...
        pr_result = await asyncio.to_thread(self._open_pr, proposal, diff)
        ...
        if pr_url:
            ...
            return {"outcome": "proposed", "pr_url": pr_url}
    ...
    def _open_pr(self, proposal: dict, diff: dict[str, str]) -> dict:
