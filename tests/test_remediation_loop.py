...
class TestRemediationLoop:
    ...
    @patch("agentit.slo_collector.collect_slo")
    def test_verify_slos_availability_above_target_is_healthy(self, mock_collect):
    ...
    @patch("agentit.slo_collector.collect_slo")
    def test_verify_slos_availability_below_target_is_breached(self, mock_collect):
